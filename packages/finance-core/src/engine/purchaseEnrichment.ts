...
let supabasePublicBaseUrl: string | undefined

/** Inject Vite/env Supabase URL for Storage public object links (call once from app bootstrap). */
export function setPurchaseImageBaseUrl(url: string | undefined): void {
  supabasePublicBaseUrl = url?.replace(/\/$/, '') || undefined
}
