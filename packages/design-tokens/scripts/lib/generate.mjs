...
const STRUCTURAL_SECTIONS = [
  ...
  [
    ...
    'appbar-height',
    'page-header-h',
    'kenos-chrome-top-inset',
    'kenos-chrome-inline',
    'kenos-chrome-header-pad-bottom',
    'kenos-chrome-title-size',
    'kenos-chrome-title-weight',
    'kenos-chrome-title-leading',
    'kenos-chrome-title-tracking',
    'kenos-chrome-control-h',
    'kenos-chrome-control-radius',
    'kenos-chrome-cluster-radius',
    'kenos-chrome-icon-size',
    'kenos-chrome-title-to-content',
    'nav-leading',
    'nav-trailing',
  ],
  [
