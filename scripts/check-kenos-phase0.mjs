...
const phase2Allowed = ledger.includes('LOCAL_BETA_IN_PROGRESS_NO_PRODUCTION_CUTOVER')
  ? [
      ...
      /^apps\/aios\/src\/lib\/components\/(BottomNav|ChatSidebar|ReadSourceState)\.svelte$/,
      /^apps\/aios\/src\/lib\/(demoMode|lifeos)\.js$/,
      /^apps\/aios\/src\/lib\/readProjections\.core\.test\.js$/,
      /^apps\/aios\/src\/lib\/i18n\/messages\/(en|zh)\.js$/,
      /^apps\/aios\/src\/routes\/(\+layout|\+page|history\/\+page|assistant\/\+page|inbox\/\+page|approvals\/\+page|activity\/\+page|chat\/\+page|\[\.\.\.missing\]\/\+page)\.svelte$/,
      /^apps\/portal\/package\.json$/,
      /^apps\/portal\/scripts\/kenos-strangler-routing\.test\.mjs$/,
      /^apps\/portal\/src\/lib\/(apps|commandPaletteActions|iconRegistry)\.js$/,
      /^apps\/portal\/src\/lib\/kenosStrangler\.js$/,
      /^apps\/portal\/src\/routes\/(\+layout|\+page)\.svelte$/,
