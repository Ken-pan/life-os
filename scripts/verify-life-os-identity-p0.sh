...
if [[ -n "$TOKEN" ]]; then
  ...
  for host in finance.kenos.space music.kenos.space planner.kenos.space fitness.kenos.space \
              financeos-ken.netlify.app musicos-ken.netlify.app planneros-ken.netlify.app fitnessos-ken.netlify.app; do
