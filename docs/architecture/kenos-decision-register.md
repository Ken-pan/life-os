...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| KENOS-001 | 产品品牌为 Kenos，内部领域 ID 与用户文案分离                                                                                                                              | ID_TABLE_FROZEN_COPY_CUTOVER_LOCAL      | 旧路由保留期与域名 redirect 随 Portal/brand slice 另定                | 不做超级 rename；ID 表见 [`kenos-naming-table.md`](./kenos-naming-table.md)（2026-07-22 冻结，8 app 用户文案已切 Kenos 命名，未部署）     |
...
| KR-P4B-TEMP-003 | Local UN center shipped (Plan / Training / AIOS / Money bills / Health edge); quiet hours defer UN; Lock Screen redacts sensitive; no APNs. PWA still SW/Web Push | TEMPORARY_APPROVED_FOR_PHASE_4B_CROSS_DEVICE_DAILY_LOOP | Critical alerts disabled/not requested          | Before APNs review     |
