...
| Paper Pro Move | 🟡 | P-MOVE-1–4 + P-MOVE-BLOCK recovery/preview ✅；Git production confirmation pending |
...
| P-MOVE-BLOCK | Production recovery and normal-config preview pass; merge-triggered Git production deploy still requires function-manifest confirmation |
