...
**FINC.PURCHASE.6 canonical（2026-07-11）：** [`../../../apps/finance/docs/FP6_PURCHASE_REVIEW.md`](../../../apps/finance/docs/FP6_PURCHASE_REVIEW.md) — discovery **CONDITIONAL PASS** · FINC.PURCHASE.6.a **BLOCKED** · [Implementation guide](../../../apps/finance/docs/FP6_PURCHASE_REVIEW_IMPLEMENTATION_GUIDE.md)
...
**FINC.CORE.2** 第二扩展源 · Review queue 全量 UI（并入 **FINC.PURCHASE.6**）· `ui-react`（hub ✗）· broad apply 全量订单（handoff 明确禁止）
