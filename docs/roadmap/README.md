...
| [`PLATFORM.md`](./PLATFORM.md)       | PLAT.CONTRACTS.0–PLAT.CORE.2 完成记录 + 矩阵 | 共享包提取或 app 接入契约时 |
| [`DESIGN.md`](./DESIGN.md)           | DSGN.CATALOG.0–DSGN.CATALOG.5 阶段史 + 前瞻 | catalog / tokens 里程碑时   |
...
执行顺序：hub §推荐执行顺序 · [`COMPOUND.md`](./COMPOUND.md) · [`POTENTIAL.md`](./POTENTIAL.md) · [`BACKLOG.md`](./BACKLOG.md)
