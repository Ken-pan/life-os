...
| --------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Life OS 品牌                            | 多处 Life OS/Kenos 混用                                     | 用户可见 Kenos，稳定内部 ID                                                                     | COPY_AND_DOMAIN_REFS_LOCAL_DONE_NOT_DEPLOYED（2026-07-22：命名表+域名表冻结于 `../architecture/kenos-naming-table.md`；8 app 文案已切 Kenos 命名，AIOS 改名 Korben；plan/money/library/training 新子域已切遍仓库侧引用（web+Apple+扩展+auth 配置），DNS/Netlify/Supabase/app_registry 待 Owner 按 cutover 清单执行；.app 包名未动） | 命名表冻结 ✅；域名表冻结 ✅                                                                                              | 不涉及数据 writer                                                                                              | 恢复文案/redirect                                              | 旧文案/域名无必要引用                                                                                                   |
...
| Planner → Plan                          | Planner UI/表/本地缓存                                      | `plan` 领域语义                                                                                 | USER_COPY_RENAMED_STORAGE_UNCHANGED（2026-07-22 文案已切 Kenos Plan；表/API 未动）                                                                                         | owner inventory                                                                                                            | 先保持原表 writer，仅更改 API/名称                                                                             | 路由/文案回退                                                  | 旧名称兼容到 deep links 稳定                                                                                            |
...
| Knowledge → Library                     | Vault + KnowledgeOS                                         | Library Space/API                                                                               | USER_COPY_RENAMED_STORAGE_UNCHANGED（2026-07-22 文案已切 Kenos Library；Tauri .app 包名与 `knowledgeos://` 深链 scheme 未动）                                              | Library/Memory 边界                                                                                                        | Vault 仍唯一正文 writer                                                                                        | 旧壳继续                                                       | 新客户端能编辑/恢复/深链                                                                                                |
| Fitness → Training                      | Fitness app/schema                                          | Training Space/domain                                                                           | USER_COPY_RENAMED_STORAGE_UNCHANGED（2026-07-22 文案已切 Kenos Training）                                                                                                  | domain ID freeze ✅（命名表 2026-07-22）                                                                                   | 不先改存储                                                                                                     | 文案回退                                                       | 行为与历史数据 parity                                                                                                   |
| Finance → Money                         | Finance app/schema                                          | Money Space/domain                                                                              | USER_COPY_RENAMED_STORAGE_UNCHANGED（2026-07-22 文案已切 Kenos Money）                                                                                                     | domain ID freeze ✅（命名表 2026-07-22）                                                                                   | 不先改存储                                                                                                     | 文案回退                                                       | 报表/导入/购买历史 parity                                                                                               |
| HealthOS → Health                       | local JSON/HealthKit/Tauri                                  | Health domain + Kenos clients                                                                   | USER_COPY_RENAMED_STORAGE_UNCHANGED（2026-07-22 文案已切 Kenos Health；`~/Library/Application Support/HealthOS/` 数据目录、FocusAgent 与 .app 包名未动）                   | OPEN-001                                                                                                                   | HealthKit/本地数据 writer 冻结后切                                                                             | 旧 companion/Tauri                                             | 真机、离线、隐私与恢复通过                                                                                              |
