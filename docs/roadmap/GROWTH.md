...
**桶定义：** 在 Core/Infra 闭环后，用**极小改动**放大已有基建（`core_*`、`life_events`、Portal、各 app RPC/扩展），提升「六 app 一体」体感。不做全站 AI；**Home 保持实验 tier**（HOME.PORTAL.1–HOME.SSO.3 ✅ 2026-07-09）。
...
云同步（HOME.PROJ.4）见 [`INTEGRATION.md`](./INTEGRATION.md#h-p0) §Parked。（**HOME.PROJ.5** 平面浏览/编辑 ✅ 2026-07-08）
...
| **HOME.PROJ.4**    | Home spatial Supabase 云同步           | HOME.SSO.2/3 后且每天用 Home              |
