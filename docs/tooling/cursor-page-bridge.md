...
> **状态**：MVP 已落地 → [`tools/web-state-devtools/`](../../tools/web-state-devtools/)
> **更新**：2026-07-06
...
配置示例见 [`tools/web-state-devtools/README.md`](../../tools/web-state-devtools/README.md)。
...
Generic snapshot 与站点逻辑分离。Amazon 订单见 [`recipes/amazon-orders.md`](../../tools/web-state-devtools/recipes/amazon-orders.md)：
