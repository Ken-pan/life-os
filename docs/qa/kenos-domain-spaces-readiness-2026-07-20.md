...
| Assistant/AIOS | aios-kenos | Read-only maintenance live | Approval decide / Capture UI bake | Flags OFF; Executor OFF |
...
| Music | musicos-ken | Legacy | Read projection only first | No Kenos writer schema |
| Home | homeos-ken | Experimental | Spatial + SSO | WIP |
