...
| `roadmap/GROWTH.md`  | 同上                  | Growth 调研或排期变化时 |
| `ops/*`              | 运维                  | 部署/infra 变更时       |
...
3. **阶段细节** → 对应 `roadmap/INTEGRATION|PLATFORM|DESIGN|GROWTH.md`
...
2. `docs/ops/canonical.md` — 别改错仓库
3. 任务相关分卷（`roadmap/*`、`architecture/*`、`ops/*`）
4. `packages/*/README.md` — 实现细节
