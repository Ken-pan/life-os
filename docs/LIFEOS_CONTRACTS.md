...
| `FinanceBillDueSchema` / `LifeEventSchema` / `LifeEvent` | events     | **Zod runtime**；I-P1.5 WIP |
...
远程 DB：`life_events` 表 migration `20260708000000` **尚未 apply**；见 [`LIFEOS_ROADMAP.md`](./LIFEOS_ROADMAP.md) §I-P1.5。
