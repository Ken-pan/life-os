...
> 边界与依赖：[`LIFEOS_SHARED_BOUNDARIES.md`](./LIFEOS_SHARED_BOUNDARIES.md)
...
- [`LIFEOS_CONTRACTS_P0.md`](./LIFEOS_CONTRACTS_P0.md) — P0 export whitelist
- [`LIFEOS_P0_PR_PLAN.md`](./LIFEOS_P0_PR_PLAN.md) — implementation PRs
- [`LIFEOS_SHARED_BOUNDARIES.md`](./LIFEOS_SHARED_BOUNDARIES.md) — dependency rules
