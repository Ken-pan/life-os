...
enum KenosDomainRegistry {
    ...
    static let definitions: [Definition] = [
        .init(id: "kenos", label: "Korben", subtitle: "Today · Ask · Inbox", strategy: .native, appId: "aios", productionOrigin: "https://www.kenos.space", devPort: 5219, homePath: "/", systemImage: "circle.grid.2x2.fill", aliases: [], accent: .kenos),
        .init(id: "plan", label: "Plan", subtitle: "Tasks and schedule", strategy: .embeddedWeb, appId: "planner", productionOrigin: "https://plan.kenos.space", devPort: 5188, homePath: "/", systemImage: "checklist", aliases: ["planner", "planner-os"], accent: .plan),
        .init(id: "training", label: "Training", subtitle: "Fitness workouts", strategy: .embeddedWeb, appId: "fitness", productionOrigin: "https://training.kenos.space", devPort: 5190, homePath: "/", systemImage: "figure.strengthtraining.traditional", aliases: ["fitness", "fitnessos"], accent: .training),
        ...
        // 用户可见 label 统一为 Finance(域 id 仍冻结为 "money" —— 那是数据契约,
        // 不是产品名)。真机 review P0-3:同一 Space 在别处叫 Finance、锁屏叫 Money。
        .init(id: "money", label: "Finance", subtitle: "Cash flow and decisions", strategy: .embeddedWeb, appId: "finance", productionOrigin: "https://money.kenos.space", devPort: 5180, homePath: "/home/today", systemImage: "dollarsign.circle", aliases: ["finance", "financeos", "finance-os"], accent: .money),
        .init(id: "library", label: "Library", subtitle: "Knowledge vault", strategy: .embeddedWeb, appId: "knowledge", productionOrigin: "https://library.kenos.space", devPort: 5879, homePath: "/library", systemImage: "books.vertical", aliases: ["knowledge", "knowledgeos", "knowledge-os"], accent: .library),
