...
const ALLOW_BESTBUY =
  process.env.WEB_STATE_ALLOW_BESTBUY === '1' || ALLOW_ANY
...
httpServer.listen(PORT, HOST, () => {
  ...
  console.log(
    `Dev whitelist: localhost, 127.0.0.1, *.netlify.app (ALLOW_ANY=${ALLOW_ANY}, ALLOW_AMAZON=${ALLOW_AMAZON}, ALLOW_BESTBUY=${ALLOW_BESTBUY})`,
  )
})
