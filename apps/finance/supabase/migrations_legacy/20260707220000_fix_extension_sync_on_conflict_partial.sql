-- Match partial unique index transactions_user_capture_platform_uidx in ON CONFLICT (42P10).
-- Index: (user_id, capture_source, platform_id) WHERE platform_id IS NOT NULL AND platform_id <> ''
