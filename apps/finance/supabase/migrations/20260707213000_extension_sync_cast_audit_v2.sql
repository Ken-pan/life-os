-- Extension sync RPC cast audit v2:
-- - Safe JSON readers for int/bigint + hardened bool/numeric/date
-- - Per-transaction diagnostics on 22P02 (envelope, txn index, raw elem)
-- - No bare (json ->> field)::type casts in finalize_extension_sync_v1
...
create or replace function public.fos_ext_json_int(
  elem jsonb,
  key text,
...
create or replace function public.fos_ext_json_bigint(
  elem jsonb,
  key text,
  default_val bigint default null
)
returns bigint
language sql
immutable
