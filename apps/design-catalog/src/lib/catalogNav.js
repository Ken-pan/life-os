...
export const CATALOG_SECTIONS = [
  ...
  },
  {
    ...
    label: 'Progress',
    group: 'theme',
    testId: 'showcase-progress',
  },
  {
    id: 'chips',
    label: 'Chips',
    group: 'theme',
    testId: 'showcase-chips',
  },
  {
    id: 'stat',
    label: 'Stat / KPI',
    group: 'theme',
    testId: 'showcase-stat',
  },
  {
    id: 'lists',
    label: 'Lists & Table',
    group: 'theme',
    testId: 'showcase-lists',
  },
  {
    id: 'display',
    label: 'Display',
    group: 'theme',
    testId: 'showcase-display',
  },
  {
    id: 'disclosure',
    label: 'Disclosure',
  ...
  },
  {
    ...
    label: 'Sheet & Dialog',
    group: 'components',
    testId: 'showcase-overlay',
  },
  {
    id: 'forms',
    label: 'Forms',
    group: 'components',
    testId: 'showcase-forms',
  },
  {
    id: 'selection',
    label: 'Selection controls',
    group: 'components',
    testId: 'showcase-selection',
  },
  {
    id: 'tabs',
    label: 'Tabs',
