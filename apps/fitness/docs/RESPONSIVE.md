...
Planner / FinanceOS / FitnessOS 共用 monorepo 内 `packages/theme`（`@import '@life-os/theme/design-system.css'`）。本文档为早期三端 **走查结论 + 统一方案**；四端 canonical shared docs 见 [`../../../docs/README.md`](../../../docs/README.md)。
