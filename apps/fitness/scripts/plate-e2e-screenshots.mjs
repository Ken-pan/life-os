...
const OUT = join(process.cwd(), 'screenshots/plate-e2e-review');
...
async function seed(page, o = {}) {
  ...
  await page.evaluate((data) => {
    ...
    s.settings = { unit: 'lbs', plateCollarLbs: 0, plateCollarKg: 0, ...data.settings };
