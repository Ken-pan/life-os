...
async function main() {
  ...
  await shot(page, '01-focus-full-topped-increase', {
    locator: page.locator('.focus-sheet-top'),
  })
  await page.goto(BASE + '/')
  await page
    .waitForSelector('.coach-card, [class*="coach"]', { timeout: 5000 })
    .catch(() => {})
  ...
  await shot(page, '03-focus-partial-sets-2of4', {
    locator: page
      .locator('.focus-header, .focus-weight-col')
      .first()
      .or(page.locator('.focus-session'))
      .first(),
  })
  if (hasPartialIncrease) {
    await shot(page, '03b-focus-partial-shows-increase-bug', {
      locator: partialAdvice,
    })
  }
  ...
  await shot(page, '04-focus-no-rir-two-sessions', {
    locator: page.locator('.focus-sheet-top'),
  })
  ...
  await page.goto(`${BASE}/day/chest/focus`)
  await shot(page, '06-focus-kg-increase-badge', {
    locator: page.locator('.focus-weight-col'),
  })
  ...
  await page.goto(`${BASE}/day/chest/focus`)
  await shot(page, '08-focus-deload-decrease', {
    locator: page.locator('.focus-sheet-top'),
  })
  ...
  await shot(page, '11-weight-modal-kg-advice', {
    locator: page.locator('.modal.wtm'),
  })
