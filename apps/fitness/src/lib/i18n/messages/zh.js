...
export default {
  ...
  focus: {
    ...
    skipRest: '跳过休息 · 第 {set} 组',
    skipRestNext: '跳过休息 · 下一动作',
    skipRestAria: '跳过休息，开始第 {set} 组',
    viewSummary: '查看训练总结',
    skippedEx: '已跳过此动作',
    exCompleted: '此动作已完成',
    prevEx: '上一个',
  ...
  settings: {
    ...
    cloudSsoHint:
      '与 Planner / Finance / Music / Home 等共用同一 Life OS 账号；本机登录一次后，其它站点可自动接上。',
    signInLink: '登录 / 注册',
  ...
  program: {
    tag: '计划',
    title: '训练计划',
    intro: '{rotation} · 练完一天自动推荐下一天。',
    cycleLabel: '计划周期',
    frequencyLabel: '训练频率',
    frequencyValue: '{n} 天/周',
    managePlan: '管理计划',
    customEdit: '管理计划',
    todayPick: '今天训练',
    ariaToday: '今天训练：{cn} {name}，约 {min} 分钟，{count} 个动作{last}',
    ariaLast: '，上次 {date}',
  },
  discover: {
    tag: '资料',
    title: '资料',
    subtitle: '知识 · 记录 · 工具 · 统计',
    intro: '训练知识、历史记录、趋势分析和实用计算器。',
    sectionLearn: '学习与工具',
    sectionMine: '我的训练',
    libraryTitle: '训练知识',
  ...
  auth: {
    ...
    hasAccount: '已有账号？',
    footnote:
      '与 Planner / Finance / Music / Home 等共用同一 Life OS 账号。登录后可将训练记录备份到云端，换设备也能恢复；数据仅你本人可见。',
  ...
  stats: {
    ...
    mvHigh: '偏高',
    mvLowHint:
      '{group} 本周仅 {sets} 组，低于最低有效容量 {mev} —— 增肌刺激不足',
