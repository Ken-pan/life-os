...
export default {
  ...
  layout: {
    ...
    titleDiscover: 'Library',
    titleTools: 'Tools',
    titleRecords: 'Workout Log',
    titleStats: 'Stats',
    titleLibrary: 'Exercises',
  ...
  focus: {
    ...
    skipRest: 'Skip rest · Set {set}',
    skipRestNext: 'Skip rest · Next exercise',
    skipRestAria: 'Skip rest and start set {set}',
    viewSummary: 'View summary',
  ...
  settings: {
    ...
    cloudSsoHint:
      'Same Korben account as Planner / Money / Music / Home — sign in once on this device and the other sites can pick it up.',
  ...
  coach: {
    ...
    adviceLabel: 'Advice',
    reasonLabel: 'Why',
    statusGood: 'Recovered well',
    statusWarn: 'Needs adjustment',
    statusAction: 'Action suggested',
    statusInfo: 'FYI',
  ...
  program: {
    ...
    intro: '{rotation} — finish a day to advance the next recommendation.',
    cycleLabel: 'Block',
    frequencyLabel: 'Frequency',
    frequencyValue: '{n} days/week',
    managePlan: 'Manage plan',
    customEdit: 'Manage plan',
    todayPick: "Today's workout",
    ariaToday: "Today's workout: {cn} {name}, ~{min} min, {count} exercises{last}",
    ariaLast: ', last {date}',
  },
  discover: {
    tag: 'Library',
    title: 'Library',
    subtitle: 'Knowledge · Log · Tools · Stats',
    intro: 'Training knowledge, history, trends, and calculators.',
    sectionLearn: 'Learn & tools',
    sectionMine: 'My training',
  ...
  auth: {
    ...
    footnote:
      'Same Korben account as Planner / Money / Music / Home. Sign in to back up workouts and restore on another device — data is private to you.',
  ...
  stats: {
    ...
    bwNote: 'Weigh in daily, track the trend',
    bwCurrent: 'Current',
    bwPlaceholder: "Today's weight",
    bwLog: 'Log',
    bwUpdate: 'Update',
    bwEmpty: 'Log your first weigh-in to see the trend here.',
    bwDelta: '{sign}{delta} {unit} over {days}d',
    bwFlat: 'Flat over {days}d',
    bwLatest: 'logged {date}',
    ...
    muscleVolumeNote:
      'Weekly volume vs hypertrophy range (synergists count 0.5)',
    ...
    mvHigh: 'High',
    mvLowHint:
      '{group}: only {sets} sets this week, below the {mev}-set minimum — not enough stimulus',
    mvHighHint:
      '{group}: {sets} sets this week, above the {mrv}-set ceiling — watch recovery',
    mvEmpty:
      'Complete a few sessions to see weekly volume and gaps per muscle.',
    setsCount: '{n} sets',
