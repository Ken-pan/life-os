...
export default {
  ...
  stats: {
    ...
    mvOptimal: 'On target',
    mvHigh: 'High',
    mvLowHint: '{group}: only {sets} sets this week, below the {mev}-set minimum — not enough stimulus',
    mvHighHint: '{group}: {sets} sets this week, above the {mrv}-set ceiling — watch recovery',
    mvEmpty: 'Complete a few sessions to see weekly volume and gaps per muscle.',
    setsCount: '{n} sets',
