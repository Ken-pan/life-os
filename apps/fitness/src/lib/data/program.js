...
export { EX_BY_ID, EX_GROUPS, EX_ID_ALIASES, resolveExerciseId, exerciseIdVariants, getPoolExercisesForDay } from './exercises.js';
...
const DEDICATED_EX_IMAGE_IDS = [
  'c_bench', 'c_incdb', 'c_incmc', 'c_decmc', 'c_fly', 'ar_dip',
  'b_pull', 'b_pulldown', 'b_row', 'b_1arm', 'b_seal', 'b_ext', 'b_face',
  'ar_bbcurl', 'ar_pushdn', 'ar_preacher', 'ar_skull', 'ar_hammer', 'ar_rope', 'ar_cablecurl',
  'l_squat', 'l_hack', 'l_press', 'l_ext', 'l_curl', 'l_thrust', 'l_abd',
  'co_hlr', 'co_cablecrunch', 'co_rollout', 'co_woodchop', 'co_plank'
];

export const EXERCISE_IMAGES = Object.fromEntries(
  DEDICATED_EX_IMAGE_IDS.map((id) => [id, `/assets/images/exercises/${id}.jpg`])
);
...
function pickMany(days, fromDay, specs) {
  return specs
    .map((s) => (typeof s === 'string' ? pickEx(days, fromDay, s) : pickEx(days, fromDay, s.id, s)))
    .filter(Boolean);
}
...
const BRO_DAYS = {
    chest: {
      id: 'chest', name: 'CHEST', cn: '胸', accent: ACCENTS.chest,
      subtitle: '胸 · 前束 · 三头协同', label: '推',
      ...
      ex: pickExSpecs([
        { id: 'c_bench', w: 80, anchor: true,
          alternatives: [{ id: 'c_incmc', name: '上斜推胸器' }, { id: 'c_decmc', name: '坐姿推胸器' }] },
    ...
    back: {
      id: 'back', name: 'BACK', cn: '背', accent: ACCENTS.back,
      subtitle: '背宽 · 背厚 · 体态（后束/竖脊）', label: '拉',
      ...
      ex: pickExSpecs([
        { id: 'b_pull', anchor: true, sub: '力竭可加助力',
          alternatives: [{ id: 'b_pulldown', name: '高位下拉' }, { id: 'b_row', name: 'V 把坐姿划船' }] },
    ...
    arms: {
      id: 'arms', name: 'ARMS', cn: '臂', accent: ACCENTS.arms,
      subtitle: '二头 · 三头 · 手臂围优先', label: '臂',
      ...
      ex: pickExSpecs([
        ...
        { id: 'ar_hammer', w: 25, unit: 'LBS/侧', sets: 2, reps: '10–15', rest: 60 }
      ])
    },
    legs: {
      id: 'legs', name: 'LEGS', cn: '腿', accent: ACCENTS.legs,
      subtitle: '股四 · 腘绳 · 臀', label: '腿',
      ...
      ex: pickExSpecs([
        { id: 'l_squat', w: 55, rir: '2', anchor: true, reps: '6–10', rest: 150,
          alternatives: [{ id: 'l_hack', name: '背式哈克深蹲' }, { id: 'l_press', name: '倒蹬机' }] },
        { id: 'l_rdl', w: 95 },
    ...
    office: {
      id: 'office', name: 'MOBILITY', cn: '办公恢复', accent: ACCENTS.office, supp: true,
      subtitle: '髋屈 · 胸椎 · 肩袖 · 核心激活', label: '恢复',
      note: '适合久坐办公后或晚间放松。慢呼吸、不弹振，拉伸到有张力即可，避免拉到疼痛。可在任意训练日结尾加练，或单独安排，每周 2–3 次为宜。',
      vol: '灵活性 ~12 组 · 约 20–25 分钟',
      warmup: [
        { name: '深呼吸 + 肩胛绕环', val: '1 × 8/向', note: '放松颈肩，建立节奏' },
        { name: '站姿髋画圈', val: '1 × 6/向', note: '唤醒髋关节' }
      ],
      ex: [
        { id: 'mo_hipflex', name: '跪姿髋屈肌拉伸', m: '髋屈肌', sets: 2, reps: '30–45s/侧', rest: 30, rir: '静控', w: 0, sub: '自重',
          cues: ['后膝着地，前脚平放，骨盆微后倾', '感受前侧髋拉伸，避免弓腰', '呼气时加深幅度，不弹振'] },
        { id: 'mo_catcow', name: '猫牛式', m: '脊柱灵活', sets: 2, reps: '10–12', rest: 30, rir: '慢控', w: 0, sub: '自重',
          cues: ['四足支撑，吸气塌腰抬头', '呼气卷背低头，逐节活动', '幅度舒适范围内，不强行折腰'] },
        { id: 'mo_tspin', name: '四足胸椎旋转', m: '胸椎', sets: 2, reps: '8–10/侧', rest: 30, rir: '慢控', w: 0, sub: '自重',
          cues: ['一手放耳后，另一手撑地', '旋转来自胸椎，骨盆尽量不动', '呼气转到底，吸气回位'] },
        { id: 'mo_bandpa', name: '弹力带后收', m: '肩袖/后束', sets: 2, reps: '15–20', rest: 30, rir: '质量', w: 0, sub: '轻阻力带',
          cues: ['双臂前伸，弹力带拉至胸口高度', '肩胛后缩夹紧，肘略弯', '对抗圆肩，宁慢勿重'] },
        { id: 'mo_wallslide', name: '墙面滑动', m: '肩屈/上背', sets: 2, reps: '10–12', rest: 45, rir: '质量', w: 0, sub: '贴墙',
          cues: ['背、臀、后脑贴墙，手臂贴墙滑动', '上举时肩胛保持稳定，肋骨内收', '下放到可控范围即可'] },
        { id: 'mo_deadbug', name: '死虫式', m: '核心稳定', sets: 2, reps: '10/侧', rest: 45, rir: '慢控', w: 0, sub: '自重',
          cues: ['仰卧，下背贴地，对侧手脚缓慢伸展', '伸展时呼气，核心保持收紧', '腰离地就缩小幅度'] },
        { id: 'mo_lunge', name: '行走弓步拉伸', m: '髋/股四', sets: 2, reps: '8/侧', rest: 30, rir: '静控', w: 0, sub: '自重',
          cues: ['大步弓步，后膝可轻触地', '骨盆中立，感受前侧髋与股四', '慢走慢停，不借惯性'] }
      ]
    },
    /* 晨间激活：附加训练，短时唤醒全身。 */
    morning: {
      id: 'morning', name: 'ACTIVATE', cn: '晨间激活', accent: ACCENTS.morning, supp: true,
      subtitle: '流动拉伸 · 关节唤醒 · 轻有氧', label: '激活',
      ...
      ex: [
        { id: 'mo_world', name: '全球最伟大拉伸', m: '全身流动', sets: 2, reps: '5/侧', rest: 30, rir: '慢控', w: 0, sub: '自重',
          cues: ['弓步 → 同侧手肘触地 → 旋转展臂', '一步流动，不卡节奏', '幅度从小开始'] },
        { id: 'mo_inchworm', name: '英寸虫', m: '后链/核心', sets: 2, reps: '6–8', rest: 30, rir: '慢控', w: 0, sub: '自重',
          cues: ['站立前屈手触地，小步走至平板', '再小步走回，腿尽量伸直', '核心收紧，避免塌腰'] },
        { id: 'mo_hipcircle', name: '站姿髋环绕', m: '髋关节', sets: 2, reps: '8/向', rest: 25, rir: '质量', w: 0, sub: '自重',
          cues: ['扶墙单腿站立，髋画大圈', '内外各一圈，骨盆稳定', '激活臀中肌与髋囊'] },
        { id: 'mo_armcircle', name: '手臂环绕 + Y 字上举', m: '肩带', sets: 2, reps: '10/向', rest: 25, rir: '质量', w: 0, sub: '自重',
          cues: ['先小后大画圈，再 Y 字上举', '上举时肩胛下沉，不耸肩', '配合呼吸，节奏均匀'] },
        { id: 'mo_bwsquat', name: '自重深蹲激活', m: '下肢', sets: 2, reps: '12–15', rest: 45, rir: '质量', w: 0, sub: '自重',
          cues: ['脚略宽于肩，脚尖微外八', '下蹲至舒适深度，膝跟脚尖同向', '底部停 1 秒再站起，不弹起'] }
      ]
    }
};
...
const UL_DAYS = {
  upper_a: {
    id: 'upper_a', name: 'UPPER A', cn: '上肢 A', accent: ACCENTS.chest,
    subtitle: '推 · 胸肩三头 · 上肢优先', label: '推',
    ...
    ex: pickMany(BRO_DAYS, 'chest', ['c_bench', 'c_incdb', 'c_incmc', 'c_fly', 'ar_dip', 'c_dbpress']).concat(
      pickMany(BRO_DAYS, 'arms', ['ar_pushdn']),
      pickExSpecs([{ id: 'sh_latraise', sets: 2, w: 12, unit: 'LBS/侧' }])
    )
  },
  lower_a: {
    id: 'lower_a', name: 'LOWER A', cn: '下肢 A', accent: ACCENTS.legs,
    subtitle: '股四 · 腘绳 · 臀 · 主强度', label: '腿',
    note: '下肢主强度日：深蹲类优先，维持臀腿基础。减脂期深蹲建议留 2 RIR，避免每周练到力竭。',
    vol: '股四 ~13 组 · 腘绳/臀 ~9 组',
    warmup: BRO_DAYS.legs.warmup,
    ex: pickMany(BRO_DAYS, 'legs', ['l_squat', 'l_hack', 'l_press', 'l_curl', 'l_thrust', 'l_abd'])
  },
  upper_b: {
    id: 'upper_b', name: 'UPPER B', cn: '上肢 B', accent: ACCENTS.back,
    subtitle: '拉 · 背 · 二头 · 体态', label: '拉',
    note: '上肢 B：垂直拉 + 水平拉建立背宽厚，面拉保护肩带；二头三头收尾补围度。',
    vol: '背 ~14 组 · 二头 ~10 组 · 三头 ~6 组',
    warmup: BRO_DAYS.back.warmup,
    ex: pickMany(BRO_DAYS, 'back', ['b_pull', 'b_row', 'b_1arm', 'b_face']).concat(
      pickMany(BRO_DAYS, 'arms', ['ar_bbcurl', 'ar_preacher', 'ar_skull', 'ar_rope'])
    )
  },
  lower_b: {
    id: 'lower_b', name: 'LOWER B', cn: '下肢 B', accent: ACCENTS.legs,
    subtitle: '股四 · 腘绳 · 臀 · 中等量', label: '腿',
...
const PPL_DAYS = {
  push_a: {
    id: 'push_a', name: 'PUSH A', cn: '推 A', accent: ACCENTS.chest,
    subtitle: '胸 · 肩 · 三头 · 复合优先', label: '推',
    note: 'PPL 推日 A：卧推和上斜为主力，经典 Reddit PPL 结构的精简版。',
    vol: '胸 ~13 组 · 三头 ~6 组',
    warmup: BRO_DAYS.chest.warmup,
    ex: pickMany(BRO_DAYS, 'chest', ['c_bench', 'c_incdb', 'c_incmc', 'c_decmc']).concat(
      pickExSpecs([{ id: 'sh_dbpress', sets: 3 }]),
      pickMany(BRO_DAYS, 'arms', ['ar_pushdn', { id: 'ar_skull', sets: 3 }])
    )
  },
  pull_a: {
    id: 'pull_a', name: 'PULL A', cn: '拉 A', accent: ACCENTS.back,
    subtitle: '背宽 · 背厚 · 二头', label: '拉',
    note: 'PPL 拉日 A：引体/下拉建背宽，划船建背厚，弯举收尾。',
    vol: '背 ~13 组 · 二头 ~7 组',
    warmup: BRO_DAYS.back.warmup,
    ex: pickMany(BRO_DAYS, 'back', ['b_pull', 'b_pulldown', 'b_row', 'b_face']).concat(
      pickMany(BRO_DAYS, 'arms', ['ar_bbcurl', 'ar_hammer'])
    )
  },
  legs_a: {
    id: 'legs_a', name: 'LEGS A', cn: '腿 A', accent: ACCENTS.legs,
    subtitle: '股四 · 腘绳 · 臀 · 主强度', label: '腿',
    note: 'PPL 腿日 A：深蹲类搭配腘绳和臀部训练，维持下肢力量基础。',
    vol: '股四 ~10 组 · 腘绳/臀 ~9 组',
    warmup: BRO_DAYS.legs.warmup,
    ex: pickMany(BRO_DAYS, 'legs', ['l_squat', 'l_hack', 'l_press', 'l_curl', 'l_thrust'])
  },
  push_b: {
    id: 'push_b', name: 'PUSH B', cn: '推 B', accent: ACCENTS.chest,
    subtitle: '上胸 · 孤立推 · 三头', label: '推',
    note: 'PPL 推日 B：上斜推和夹胸/双杠换角度，补充胸肌刺激。',
    vol: '胸 ~12 组 · 三头 ~6 组',
    warmup: BRO_DAYS.chest.warmup,
    ex: pickMany(BRO_DAYS, 'chest', ['c_incdb', 'c_incmc', 'c_fly', 'ar_dip']).concat(
      pickExSpecs([{ id: 'sh_latraise', sets: 3 }]),
      pickMany(BRO_DAYS, 'arms', ['ar_rope', 'ar_pushdn'])
    )
  },
  pull_b: {
    id: 'pull_b', name: 'PULL B', cn: '拉 B', accent: ACCENTS.back,
    subtitle: '划船 · 后束 · 二头', label: '拉',
    note: 'PPL 拉日 B：水平拉、面拉和海豹划船换动作，避免平台期。',
    vol: '背 ~12 组 · 二头 ~6 组',
    warmup: BRO_DAYS.back.warmup,
    ex: pickMany(BRO_DAYS, 'back', ['b_pulldown', 'b_row', 'b_seal', 'b_ext', 'b_face']).concat(
      pickMany(BRO_DAYS, 'arms', ['ar_cablecurl'])
    )
  },
  legs_b: {
    id: 'legs_b', name: 'LEGS B', cn: '腿 B', accent: ACCENTS.legs,
    subtitle: '倒蹬 · 孤立 · 中等量', label: '腿',
    note: 'PPL 腿日 B：倒蹬和孤立为主，强度比腿 A 略低，适合高频腿日。',
    vol: '股四 ~9 组 · 腘绳/臀 ~6 组',
    warmup: UL_DAYS.lower_b.warmup,
    ex: pickMany(BRO_DAYS, 'legs', ['l_press', 'l_hack', 'l_ext', 'l_curl', 'l_abd'])
  }
};
...
const FB_DAYS = {
  full_a: {
    id: 'full_a', name: 'FULL A', cn: '全身 A', accent: ACCENTS.chest,
    subtitle: '推 · 拉 · 腿 · 各 1 复合', label: '全身',
    ...
    ex: pickMany(BRO_DAYS, 'chest', [{ id: 'c_bench', sets: 3 }])
      ...
      .concat(pickMany(BRO_DAYS, 'legs', [{ id: 'l_squat', sets: 3, rir: '2' }]))
      .concat(pickMany(BRO_DAYS, 'arms', ['ar_bbcurl', 'ar_pushdn']))
  },
  full_b: {
    id: 'full_b', name: 'FULL B', cn: '全身 B', accent: ACCENTS.back,
    subtitle: '上胸 · 垂直拉 · 倒蹬', label: '全身',
  ...
  full_c: {
    id: 'full_c', name: 'FULL C', cn: '全身 C', accent: ACCENTS.legs,
    subtitle: '推胸器 · 划船 · 哈克', label: '全身',
...
export const PROGRAMS = [
  {
    ...
    meta: {
      ...
      athlete: ATHLETE,
      goalLabel: '手臂围度 · 上肢优先',
      description: '手臂围度优先：胸 → 背 → 腿 → 臂轮换。臂日前有腿日缓冲，且不接在背日后。每日保留核心动作，双杠/弯举等可在可选库补充。',
      source: 'FITNESS.OS 定制 · 二头/三头直接量 12–18 组/周 · RIR 1–2',
      daysPerWeek: 4,
      level: '中级',
      tags: ['默认', '手臂围优先', '上肢优先']
    },
  ...
  },
  {
    ...
    meta: {
      ...
      athlete: ATHLETE,
      goalLabel: '保肌降脂 · 上肢围度',
      description: '每个肌群每周练 2 次；两个上肢日容量略高，两个下肢日一重一轻。减脂期较均衡的选择。',
      source: '依据 Schoenfeld 等 meta-analysis：每肌群 ≥2 次/周更利于增肌；上下肢是经典 4 日结构',
      daysPerWeek: 4,
      level: '中级',
      tags: ['推荐', '减脂友好', '2×频率']
    },
  ...
  },
  {
    ...
    meta: {
      ...
      description: '推/拉/腿（PPL）各练 2 次/周，上肢刺激频率高。总容量偏大，更适合增肌期；减脂期请注意睡眠与恢复。',
      source: '源自社区经典 Reddit PPL（Metallicadpa 模板思路）· 总容量对齐 Schoenfeld 每周 10–20 组/肌群',
      daysPerWeek: 6,
      level: '中高级',
      tags: ['高频', '上肢', '高容量']
    },
  ...
  },
  {
    ...
    meta: {
      ...
      athlete: ATHLETE,
      goalLabel: '保肌 · 时间高效',
      description: '每次覆盖推、拉、腿各 1 个复合动作，并搭配臂部训练。单课时间短、恢复快，适合繁忙周或减脂初期。',
      source: 'ACSM 建议每周 ≥2 次全身阻力训练；McMaster 等研究：3 次/周全身高频在容量等同时有效',
      daysPerWeek: 3,
      level: '初中级',
      tags: ['减脂', '省时', '恢复快']
    },
