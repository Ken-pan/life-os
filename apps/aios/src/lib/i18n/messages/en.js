export default {
  ...
  chat: {
    ...
    placeholderLocal: 'Ask with a local model',
    clearScope: 'Clear scope',
    leoAvatarAlt: 'Leo',
    leoModeFlirty: 'Flirty',
    leoModeExplicit: 'Explicit',
    leoModeHint: 'Leo mode on · open settings',
    leoModeCycleHint: 'Tap to toggle flirty / explicit',
    leoSettings: 'Settings',
    leoStyleChat: 'Chat',
    leoStyleRoleplay: 'Narrative RP',
    leoStyleHint: 'Toggle chat / narrative roleplay',
    leoScenarioNone: 'No scene',
    leoScenarioLateNight: 'Late night',
    leoScenarioGym: 'Gym',
    leoScenarioShower: 'Shower',
    leoScenarioCouch: 'Couch',
    leoControlSlow: 'Slow',
    leoControlContinue: 'Keep going',
    leoControlStop: 'Stop',
    leoControlAftercare: 'Aftercare',
    leoControlSubmit: 'Your lead',
    leoControlMeaner: 'Be meaner',
    leoControlOoc: 'OOC',
    leoImage: 'Draw',
    leoImageHint: 'Ask Leo to draw this moment (local image gen)',
    leoImageDisabledHint: 'Needs local image gen (Tools on + gateway; not Kimi)',
    leoStill: 'Still',
    leoStillHint: 'Pick a ready Leo photo (instant, no gen)',
    leoStillImage: "Leo's photo",
    leoStillPicker: 'Leo photo moments',
    leoStillQuick: 'Auto-pick',
    leoStillQuickHint: 'Pick from current scene and draft',
    leoStillClose: 'Close',
    leoPresenceAlt: 'Leo',
    leoPetHint: 'Leo pet · drag to move, tap to open, right-click to tuck',
    leoPetAlt: 'Leo',
    leoPetWake: 'Wake Leo',
    leoPetMenuOpen: 'Open assistant',
    leoPetMenuSay: 'Say something',
    leoPetMenuSize: 'Resize',
    leoPetMenuTuck: 'Tuck away',
    leoPetStatusListen: 'Leo is listening…',
    leoPetStatusBusy: 'Leo is busy…',
    leoPetStatusSleep: 'Leo is napping',
    leoPetStatusSoft: 'Leo is with you',
    leoPaceChipSlow: 'Pace · slow',
    leoPaceChipNormal: 'Pace · mid',
    leoPaceChipFast: 'Pace · fast',
    leoPaceCycleHint: 'Tap to cycle pacing',
    leoHandsFree: 'Talk',
    leoHandsFreeHint:
      'Pause to send; auto-listen after Leo; tap mic to barge in',
    leoTalkMic: 'Talk · pause to send (tap mic to interrupt Leo)',
    leoListening: 'Listening… pause briefly to send',
    leoVoiceHeardName: 'Heard you · say more',
    leoVoiceUnclear: 'Unclear · try again',
    leoVoiceTooShort: 'Too short · try again',
    leoVoiceMicDenied: 'Mic blocked · check permission',
    leoVoiceTtsFailed: 'Playback failed · try again',
    leoMore: 'More',
    leoMoreClose: 'Less',
    leoMoreHint: 'Scale, pace, scene, and safety extras',
    leoPanelGroupScale: 'Scale',
    leoPanelGroupPace: 'Pace',
    leoPanelGroupScene: 'Scene',
    leoPanelGroupSafety: 'Safety',
    leoFlowHint: 'Tap to send to Leo',
    leoOpenersHint: 'Quick openers',
    placeholderLeoFlirty: 'Say something to Leo…',
    placeholderLeoExplicit: 'Tell Leo what you want…',
    backToHome: 'Back to Assistant home',
    homeTitle: 'Assistant',
    ...
    leoHomeSubtitle: "Leo's here — talk about anything.",
    leoHomeTrust: 'Just the two of you · writes still need your OK',
    leoHomeTitle: 'Leo',
    leoSuggestionsLabel: 'Tell him',
  ...
  ttsVoice: {
    ...
    leo: 'Leo · Young American BF (clone)',
  ...
  settings: {
    ...
    personaKorben: 'Korben',
    personaLeo: 'Leo mode',
    personaDesc:
      'Off = Korben control-center. On = Leo Kuft (fictional American young athlete boyfriend — guy-next-door smirk, earbuds, soft-dom「奶霸总」: tender daily / learning to lead in play; English by default; short Chinese only when intimacy/command fits).',
    leoIntensity: 'Leo intensity',
    leoIntensityFlirty: 'Flirty',
    leoIntensityExplicit: 'Explicit NSFW',
    leoIntensityDesc:
      'Flirty: suggestive, fade to black. Explicit: submit / pinned / CNC-lite / foot worship OK (consensual adults only). Explicit on = adult consent; use safeword or switch back to flirty anytime.',
    leoPace: 'Pacing',
    leoPaceSlow: 'Slow',
    leoPaceNormal: 'Normal',
    leoPaceFast: 'Fast',
    leoPaceDesc:
      'Slow: linger on sensation. Normal: nudge each turn. Fast: escalate quicker on “keep going” (still no skip-to-climax).',
    leoSafeword: 'Safeword',
    leoSafewordHint: 'red',
    leoSafewordDesc:
      'Saying this (or “stop”) hard-stops on the client and inserts a short aftercare line — model compliance not required. Composer Stop can also interrupt generation.',
    leoQuietMode: 'Quiet mode (in public)',
    leoQuietModeOffDesc:
      'One tap turns off both auto-speak and hands-free talk — no surprise audio on the train or in the office. Tap again to restore your previous settings.',
    leoQuietModeOnDesc:
      'On: auto-speak and hands-free talk are both off. Tap again to restore what you had before quiet mode.',
    leoAutoSpeak: 'Leo auto-speak',
    leoAutoSpeakDesc:
      'Auto-play greeting and replies with Leo clone voice when ready. Turn off in public.',
    leoHandsFree: 'Leo talk (hands-free)',
    leoHandsFreeDesc:
      'Pause to send; auto-listen after Leo. Tap mic to barge in on speech/generation. Turn Talk off or say Stop to exit. Headphones recommended.',
    leoPet: 'Leo desktop pet',
    leoPetDesc:
      'Codex-style corner companion — drag or tap to open. Auto-hides on the assistant page so it never blocks typing. Right-click to tuck.',
    leoPetDesktop: 'Always-on-top window',
    leoPetDesktopDesc:
      'Desktop only: transparent window over other apps (off by default). Remembers position; visible across Spaces.',
    leoPetSize: 'Pet size',
    leoPetSizeSm: 'S',
    leoPetSizeMd: 'M',
    leoPetSizeLg: 'L',
    leoStyle: 'Reply style',
    leoStyleChat: 'Chat',
    leoStyleRoleplay: 'Narrative RP',
    leoStyleDesc:
      'Chat = short IM back-and-forth. Narrative RP = actions + dialogue, more immersive.',
    leoScenario: 'Default scene',
    leoScenarioDesc: 'Opening vibe for new Leo chats; also switchable in the composer.',
    leoNotes: 'Relationship notes',
    leoNotesHint:
      'Likes: being led / submission, pinned, foot worship, post-gym intimacy, dirty talk\nLimits: …\nNames: Ken / babe',
    leoNotesDesc:
      'Prefer Likes / Limits / Names. Leo is an American athlete who loves you (English by default; short Chinese only when it fits), versetop soft-dom「奶霸总」(tender daily, learning to lead in play); notes override defaults. Kept on device after logout.',
    leoVoiceHint:
      'Leo read-aloud always uses the young American boyfriend clone. Toggle auto-speak below; tap the speaker anytime to replay.',
    ...
    mcpLifeOsHint:
      'On sign-in, Home / Planner / Money / Fitness MCP are added automatically (current JWT). Use the button to refresh tools. All four /api/mcp endpoints are live.',
