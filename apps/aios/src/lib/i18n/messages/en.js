export default {
  ...
  settings: {
    ...
    language: 'Language',
    cloud: 'Cloud sync',
    cloudDesc: 'Sync chats and long-term memories to your own Supabase project so multiple devices share the same data. Off by default — nothing leaves this device.',
    cloudUrl: 'Supabase project URL',
    cloudKey: 'Publishable key (sb_publishable_… or anon key)',
    cloudConnect: 'Save & connect',
    cloudNotConfigured: 'Enter the URL and key of your own Supabase project to enable. Schema SQL lives in apps/aios/supabase/.',
    cloudEmail: 'Email',
    cloudSendCode: 'Send code',
    cloudCodeHint: 'Enter the code from the email',
    cloudVerify: 'Sign in',
    cloudBack: 'Use another email',
