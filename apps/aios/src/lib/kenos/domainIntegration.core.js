...
export const DOMAIN_REGISTRY = Object.freeze({
  ...
  plan: defineDomain({
    ...
    appId: 'planner',
    productionOrigin: 'https://plan.kenos.space',
    devPort: 5188,
    homePath: '/',
  ...
  training: defineDomain({
    ...
    strategy: 'embedded_web',
    appId: 'fitness',
    productionOrigin: 'https://training.kenos.space',
    devPort: 5190,
    homePath: '/',
  ...
  money: defineDomain({
    ...
    strategy: 'embedded_web',
    appId: 'finance',
    productionOrigin: 'https://money.kenos.space',
    devPort: 5180,
    homePath: '/home/today',
  ...
  library: defineDomain({
    ...
    strategy: 'embedded_web',
    appId: 'knowledge',
    productionOrigin: 'https://library.kenos.space',
    devPort: 5879,
