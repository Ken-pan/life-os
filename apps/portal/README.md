...
> **路线图：** [`docs/LIFEOS_ROADMAP.md`](../../docs/LIFEOS_ROADMAP.md) · 细节：[`docs/roadmap/INTEGRATION.md`](../../docs/roadmap/INTEGRATION.md#i-p1) · 部署：[`docs/ops/netlify.md`](../../docs/ops/netlify.md)
