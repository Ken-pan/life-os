...
echo "=== PaperOS - reMarkable Paper Pro Move Build Script ==="
...
if [ -f "build-docker/paperos" ]; then
    echo "SUCCESS! Binary located at: build-docker/paperos"
