export default {
  ...
  schedule: {
    ...
    scheduleAction: '安排',
    scheduleActionShort: '安排时间',
    scheduleAdjustShort: '调整',
    popoverTitle: '安排时间',
    editPopoverTitle: '调整安排',
    startTime: '开始时间',
    duration: '时长',
    timeRange: '{start}–{end}',
    ...
    useNextAvailable: '移到下个空档 · {time}',
    noAvailableTime: '今天没有更晚的可用时间，请更换日期或缩短时长。',
    saveAnyway: '仍然安排',
    updateSchedule: '更新安排',
  ...
  insights: {
    title: '洞察',
    subtitle: '项目推进与完成回顾，随数据自动更新',
    planningTitle: '项目规划',
    planningEmpty: '还没有进行中的项目',
    projectMeta: '{done}/{total} 任务',
    heatmapTitle: '完成热力（近一年）',
    burnupTitle: '累计完成（近 12 周）',
    burnupSeries: '累计完成',
    doneEmpty: '还没有完成记录，完成第一个任务后这里会亮起来。',
    kpiActiveProjects: '进行中项目',
    kpiTotalDone: '累计完成',
    kpiMonthDone: '本月完成',
    kpiWeeklyAvg: '周均（近 4 周）',
    dow: ['一', '二', '三', '四', '五', '六', '日'],
  },
  completed: {
    title: '已完成',
  ...
  task: {
    createTitle: '新建任务',
    editTitle: '编辑任务',
    createDescription: '先记下要做的事，其他细节可以稍后补充。',
    editDescription: '调整任务的时间、归属与执行细节。',
    createAction: '创建任务',
    saveChanges: '保存更改',
    title: '标题',
    ...
    triageHeader: '分类元数据',
    moreOptions: '更多选项',
    detailsSummary: '更多详情 · 已设置 {count} 项',
    discardTitle: '放弃未保存的更改？',
    discardDescription: '已输入的内容将不会保留。',
    keepEditing: '继续编辑',
    discardAction: '放弃更改',
    deleteTask: '删除任务',
    deleteTitle: '删除这个任务？',
    deleteDescription: '任务会从列表中移除，删除后仍可立即撤销。',
    deleteAction: '确认删除',
    kind: '任务类型',
    kindMicro: '小推进',
    kindStandard: '标准',
