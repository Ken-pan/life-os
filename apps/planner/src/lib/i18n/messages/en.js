export default {
  ...
  home: {
    ...
    quickAdd: 'Add a task…',
    progressTitle: 'Today',
    progressCount: '{count} remaining',
    progressRemaining: '{done} done · {count} left',
    ...
    progressSummary: '{total} remaining',
  ...
  schedule: {
    ...
    unscheduled: 'Unscheduled',
    unscheduledTasks: 'Unscheduled · {count}',
