...
> **Canonical（2026-07）：** [`../../../docs/architecture/responsive-chrome.md`](../../../docs/architecture/responsive-chrome.md)
> 本文档为早期三端 **走查结论**；断点已收敛为 **mobile ≤839 / desktop ≥840**（勿再按下文 860/861 实现）。

Planner / FinanceOS / FitnessOS 共用 monorepo 内 `packages/theme`（`@import '@life-os/theme/design-system.css'`）。
...
--tabbar-h: 62px;
--tabbar-total-h: calc(
  var(--tabbar-h) + max(8px, var(--safe-bottom-effective))
);
...
@media (--life-os-compact) {
  /* ≤640px 别名 */
}
@media (--life-os-tablet) {
  /* 641–860px */
}
@media (--life-os-mobile) {
  /* ≤860px — chrome 切换 */
}
@media (--life-os-mobile-landscape) {
  /* ≤860px 横屏 */
}
