-- Review-only Phase 5→6 Focus foundation tables. Never auto-applied.
-- Platform/System owns FocusContext / DeferredItem / ProactiveSuggestion.
-- Domain sessions remain EntityRef only. No production Executor / notifications.
