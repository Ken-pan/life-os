...
/** @param {string} root Music app root (directory containing optional .env.local) */
export function loadMusicQaEnv(root) {
 ...
 */
export async function signInForMusicQa(env, options = {}) {
