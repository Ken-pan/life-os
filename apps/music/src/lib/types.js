/** @typedef {{ id: string, title: string, artist: string, album: string, albumKey: string, artistKey: string, duration: number, mime: string, size: number, addedAt: number, playCount: number, liked: 0 | 1, artUrl?: string, objectUrl?: string, words: string[] }} Track */
